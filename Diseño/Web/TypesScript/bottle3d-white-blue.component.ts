...
@Component({
  selector: 'app-bottle3d-white-blue',
  imports: [],
  templateUrl: './bottle3d-white-blue.component.html',
  styleUrl: './bottle3d-white-blue.component.css'
})
export class Bottle3dWhiteBlueComponent implements OnInit {
  @ViewChild('bottlewhiteblue', { static: true }) canvasRef!: ElementRef;
  scene!: THREE.Scene;
  ...
  loadModel() {
    ...
    this.loader.load('bottle-white-blue.glb', (gltf: any) => {
