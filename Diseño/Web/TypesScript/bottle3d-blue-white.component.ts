...
@Component({
  selector: 'app-bottle3d-blue-white',
  imports: [],
  templateUrl: './bottle3d-blue-white.component.html',
  styleUrl: './bottle3d-blue-white.component.css'
})
export class Bottle3dBlueWhiteComponent implements OnInit {
  @ViewChild('bottlebluewhite', { static: true }) canvasRef!: ElementRef;
  scene!: THREE.Scene;
  ...
  loadModel() {
    ...
    this.loader.load('bottle-blue-white.glb', (gltf: any) => {
