...
@Component({
  selector: 'app-bottle3d',
  imports: [],
  templateUrl: './bottle3d.component.html',
  styleUrl: './bottle3d.component.css'
})
export class Bottle3dComponent implements OnInit {
  @ViewChild('bottlebasic', { static: true }) canvasRef!: ElementRef;
  scene!: THREE.Scene;
  ...
  loadModel() {
    ...
    this.loader.load('bottle-basic.glb', (gltf: any) => {
