...
@Component({
  selector: 'app-bottle3d-white',
  imports: [],
  templateUrl: './bottle3d-white.component.html',
  styleUrl: './bottle3d-white.component.css'
})
export class Bottle3dWhiteComponent implements OnInit {
  @ViewChild('bottlewhite', { static: true }) canvasRef!: ElementRef;
  scene!: THREE.Scene;
  ...
  loadModel() {
    ...
    this.loader.load('bottle-white.glb', (gltf: any) => {
